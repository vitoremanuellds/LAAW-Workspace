...
| [c037-1650-68133.md](c037-1650-68133.md) | Decision: revamp open items settled — shipped epoch `2026-01-01T00:00:00Z`, router skill `route`, final template set, no Owner field, workspace new-model pilot | active | related: [architecture.md](architecture.md) |

...
| P03-T02 | Repoint `context-temp-template.md`/`context-build-plan-template.md` copy targets to `.ai/workbench/` | Templates declare the new location before the skill that uses them is updated | — | validating |

...
| P03-T05 | Add `workbench-readme-template.md` and wire it into `create-constitution-full`'s first-run bootstrap step | New projects get `.ai/workbench/README.md` automatically, same as the other three first-run templates | — | validating |

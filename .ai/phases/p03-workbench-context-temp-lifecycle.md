...
| P03-T04 | Make `build-context.iterate`'s finished-queue step delete both workbench files automatically | Replace the old ask-before-deleting step per ADR02 | P03-T03 | complete |

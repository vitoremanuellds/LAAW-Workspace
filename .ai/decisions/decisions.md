...
| ADR03 | Replace per-profile repos with one modular workflow | One workflow with optional layers (presence/granularity/locality axes) replaces separately-versioned `full`/`Light` repos; supersedes P01 | valid | — |

# P08-T07: Update define-phase skill
...
- `.ai/workflow/skills/define-phase/SKILL.md` — Step 2 of the skill's procedure currently says to leave the task table empty/unchanged. Update to always include the header row `| ID | Title | Purpose | Depends on | Status |` in the newly created phase file.

...
|---|---|---|---|---|
| t037-2427-11111 | convert-task-file-naming | Update LAAW repo skills for task.md format + add generate-id instruction, sync, then migrate .ai folder | — | in-progress |
